...
class Vertex():
    ...
    position : Float3 = json_element("position", Float3)
    
    # Normal vector of the vertex.
    normal : Float3 = json_element("normal", Float3)
    ...
    tangent : Float3 = json_element("tangent", Float3)
    
    # Color of the vertex.
    color : Color = json_element("color", Color)
    ...
    uvs : List[UV_Coordinate] = json_list("uvs", UV_Coordinate)
    ...
    bone_weights : List[BoneWeight] = json_list("boneWeights", BoneWeight)
