...
class BlendshapeRawData():
    ...
    has_normal_deltas : bool = json_element("hasNormalDeltas", bool)

    # Indicates if this blendshape has tangent deltas.
    has_tangent_deltas : bool = json_element("hasTangentDeltas", bool)

    # Frames that compose this blendshape.
    # Blendshapes need at least 1 frame.
    frames : List[BlendshapeFrameRawData] = json_list("frames", BlendshapeFrameRawData)
