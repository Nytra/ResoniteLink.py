...
class Bool2():
    x : bool = json_element("x", bool)
    y : bool = json_element("y", bool)
...
class Bool4():
    ...
    y : bool = json_element("y", bool)
    z : bool = json_element("z", bool)
    w : bool = json_element("w", bool)


@json_model(internal_type_name="t_byte2")
class Byte2():
    x : int = json_element("x", int)
    y : int = json_element("y", int)
